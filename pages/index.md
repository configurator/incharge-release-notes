...
### ניהול Z מול וריפון
הגרסה מכילה תמיכה ביצירת מספרי Z מול וריפון והעברתם עבור כל עסקה. ניהול המספרים קורה באופן עצמאי על ידי InCharge, שיוצרת מספרי Z חדשים מול וריפון במידת הצורך ומעבירה אותם במתודות הרלוונטיות.

### תמיכה בשליחת SMS ע״י שמיר

### תמיכה בקבוצות-אופציות ואופציות בתשלום
תמיכה במספר של קבוצות אופציות המכילות הגדרות אישיות כגון כמות אופציות מקסימלית לכל קטגוריה, ובחירת אופציות בתשלום.

### תמיכה בניהול סחורה בקטלוג פנימי
...
גרסה זו מכילה מספר פיתוחים חדשים, תיקוני באגים מהותיים, ושינוי

### הדפסה
תהליך ההדפסה כעת מנוהל באופן נפרד מהאפליקציה, על ידי process חדש ייעודי לעבודה מול ההדפסה. הprocess נפתח ע״י האפליקציה עבור כל בקשת הדפסה, מדפיס את המידע שהתבקש מהאפליקציה, ונסגר. בעזרת שינוי זה, אנחנו נמנעים מתקלות העולות מתעבורת בקשות הדפסה גדולה. אנחנו מאמינים ששינוי זה ימנע את תקלת חוסר התקשורת מצד המדפסת.
...
* קריאת קובץ צימוד מסופון באופן דינמי ממספר מקומות אפשריים
